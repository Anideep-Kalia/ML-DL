...
# -------------------- Config -------------------- #
DATASET_PATH = "../data/4.json"
SAVE_DIR = "../saved_model"  # fine-tuned model location
MODEL_NAME = "Salesforce/codet5-small"  # CodeT5 model
BATCH_SIZE = 4
EPOCHS = 5
LR = 5e-5
MAX_LEN = 128
...
print(f"[SUCCESS] Model and tokenizer saved to {SAVE_DIR}")
